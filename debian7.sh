...
# download script
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/daffabima67/debian7_32bit/master/menu.sh"
wget -O usernew "https://raw.githubusercontent.com/daffabima67/debian7_32bit/master/usernew.sh"
...
echo ""  | tee -a log-install.txt
echo "www.google.com"  | tee -a log-install.txt
echo "Modified by anova"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
